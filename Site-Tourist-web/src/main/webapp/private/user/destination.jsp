    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <s:form theme="bootstrap" cssClass="well form-vertical" action="addComment" method="post" >

                    <s:textarea
                                placeholder="Insert comment"
                                name="userComment.text" required="true"/>

                        <s:submit cssClass="btn btn-primary" value="Comment"/>
                </s:form>
            </div>
        </div>
